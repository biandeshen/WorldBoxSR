...
test('Meteor is a first-class catalog/button/hotkey, legacy command, and truthful Phaser feedback path', () => {
  ...
  assert.equal(godPowerMeta('meteor').label, 'Meteor · radius 2');
  assert.equal(godPowerMeta('meteor').targetRadius, 2);
